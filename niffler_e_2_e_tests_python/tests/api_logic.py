...
from niffler_e_2_e_tests_python.tests.test_auth import base_auth_url
...
def create_spending(signin_user: str, spend_amount: str, spend_category: str, spend_currency: str, spend_date: str,
